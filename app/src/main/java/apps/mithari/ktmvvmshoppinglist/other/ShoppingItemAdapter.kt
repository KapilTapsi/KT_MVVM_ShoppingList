package apps.mithari.ktmvvmshoppinglist.other
...
import apps.mithari.ktmvvmshoppinglist.ui.shoppinglist.ShoppingViewModel
...
class ShoppingItemAdapter(
    ...
    override fun onBindViewHolder(holder: ShoppingViewHolder, position: Int) {
        ...
        holder.itemView.ivDelete.setOnClickListener { viewModel.delete(currentShoppingItem) }
